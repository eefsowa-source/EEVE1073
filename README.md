...
두 코어 모두 **Input 노브를 올릴수록 새추레이션이 더 비대칭적으로
바뀌면서 짝수 배음(2차 배음 등)이 늘어나도록** 설계돼 있습니다 (FET/
트랜스포머/Class-A 스테이지가 더 세게 드라이브될수록 선형 구간에서
더 벗어난다는 개념을 반영). JUCE 플러그인 쪽은 이 하드 논리니어리티에서
